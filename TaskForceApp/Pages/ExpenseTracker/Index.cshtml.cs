...
namespace TaskForceApp.Pages.ExpenseTracker
{
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnGet()
        {
            ...
            ListIncome.Clear();
            ListExpense.Clear();
            ListExpenseLimit.Clear();

            int totalIncome = 0;
            int totalExpense = 0;
            int remaining = 0;
            int ExpenseLimitValue=0;
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                AllExpenseLimit info = new AllExpenseLimit
                                {
                                    ...
                                    ExpenseLimit = reader.GetInt32(1)
                                ...
                                ExpenseLimitValue = info.ExpenseLimit;
                            }
                        }
                    }
                }
            ...
            ViewData["ExpenseLimitValue"] = ExpenseLimitValue;
            //End of Expense Limit
